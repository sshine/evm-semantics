...
module EVM-SYMB-TESTING
    //fixme should replace copied code but
    //[Error] Internal: Could not compute least upper bound for rewrite sort. Possible candidates: [JSON, JSONKey]
    ...
    //fixme import ETHEREUM-SIMULATION, don't copy pieces like this
